...
/**
 * Bundle quote variant — Showroom + Studio canvas.
 * Dark hero, cream form with bundle multi-select.
 */
          ...
          <div className="paper-card rounded-md">
            <div className="p-6 sm:p-8 md:p-10">
              <div className="mb-6">
                ...
                <h2 className="text-xl sm:text-2xl font-heading font-black text-ink uppercase tracking-tight">Select Service Bundle(s)</h2>
                <p className="font-serif italic text-ink-muted mt-3 text-base">Click to add or remove a checkmark.</p>
              </div>
