            ...
            <CardContent className="space-y-6">
              {plan.suggestions && plan.suggestions.length > 0 && (
                <div className="p-6 card-premium border-gold/30">
                  <h3 className="text-lg font-bold text-text-primary mb-4 uppercase tracking-wide">
                    Design Suggestions
                  </h3>
              ...
              {plan.estimatedCost && (
                <div className="p-6 card-premium border-gold/30">
                  <h3 className="text-lg font-bold text-text-primary mb-2 uppercase tracking-wide">
                    Estimated Cost
                  </h3>
                  <p className="text-2xl font-black text-gold">{plan.estimatedCost}</p>
                </div>
              )}
