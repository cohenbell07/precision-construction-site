  ...
  return (
    <div className="min-h-screen bg-industrial-black texture-concrete">
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 max-w-4xl">
        <Button asChild variant="ghost" className="mb-6 sm:mb-8 md:mb-10 hover:text-gold text-text-secondary text-sm sm:text-base">
          <Link href="/blog">
        ...
        <article>
          <Card className="card-premium card-beveled border-gold/30 mb-8 sm:mb-10 md:mb-12 p-4 sm:p-6 md:p-8">
            <div className="mb-6 sm:mb-7 md:mb-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 text-xs sm:text-sm mb-4 sm:mb-5 md:mb-6">
                <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-0.5 sm:py-1 bg-industrial-slate border border-gold/30 rounded-sm">
                  <Tag className="h-2.5 w-2.5 sm:h-3 sm:w-3 text-gold" />
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 pt-6 sm:pt-7 md:pt-8 border-t border-gold/20">
